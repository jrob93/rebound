...
// -----------------------------------------------------------------------------
/**
 * @brief Calculate the kinetic and potential energy of each particle and write to file.
 * @details Does not work for SEI (shearing sheet simulations). WHY???
 * @param r The rebound simulation to be considered.
 */
